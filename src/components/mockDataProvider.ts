...
export const mockDataProvider = fakeDataProvider({
  cards: [
    {
      id: 0,
      header: 'Какая планета земля от солнца?',
      body: 'Земля - это 3-ая планета от солнца',
  ...
  streams: [
    {
      ...
      youtube: 'https://youtu.be/3pv01sSq44w',
    },
    {
      id: 1,
      category: 'launch',
  ...
  news: [
    {
      id: 0,
      imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Earth_Eastern_Hemisphere.jpg/1024px-Earth_Eastern_Hemisphere.jpg',
      newsSite: 'yandex',
      publishedAt: '02.10.2021',
      title: 'Произошел запуск',
      updatedAt: '02.10.2021',
      url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Earth_Eastern_Hemisphere.jpg/1024px-Earth_Eastern_Hemisphere.jpg',
    },
    {
      id: 1,
